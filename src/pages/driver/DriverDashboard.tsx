      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, index) => (
          <div
            ...
            className="bg-white rounded-lg shadow p-6 hover:shadow-md hover:border-gray-300 transition-all duration-200 cursor-pointer group border"
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className={`${stat.color} text-white p-3 rounded-lg group-hover:scale-110 transition-transform`}>
                  {stat.icon}
                </div>
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 group-hover:text-gray-700">
                    {stat.value}
                  </p>
                </div>
              </div>
