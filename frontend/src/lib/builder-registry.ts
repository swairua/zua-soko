...
const HeroSection = (props: {
  ...
  return React.createElement(
    ...
    {
      className:
        "bg-gradient-to-r from-green-600 to-green-800 text-white py-16",
    },
    React.createElement(
      "div",
      ...
      props.buttonText &&
        ...
        React.createElement(
          "a",
          {
            ...
            className:
              "bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors",
          },
          props.buttonText,
        ),
    ),
...
const FeatureCard = (props: {
  ...
  return React.createElement(
    ...
    props.icon &&
      React.createElement("div", { className: "text-3xl mb-4" }, props.icon),
    React.createElement(
      "h3",
      { className: "text-xl font-semibold mb-2" },
      props.title,
    ),
    React.createElement("p", { className: "text-gray-600" }, props.description),
  );
};
